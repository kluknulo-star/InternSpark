...
<div class="container-fluid">
    ...
    if ($userInSystem->getRole() == "admin") {
        require_once "$root/src/view/tableUsers/adminTable.php";
    } else {
        require_once "$root/src/view/tableUsers/userTable.php";
    }
    ...
    if (count($segments) > 1) {
        require_once "$root/src/view/tableUsers/restTable.php";
    }
    ?>
