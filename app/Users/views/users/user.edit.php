                        ...
                        <form action="?id=<?php echo $row->getId() ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="email" aria-describedby="emailHelp"
                                       value="<?php if (isset($_SESSION["try_edit_email"])) {
                                           echo $_SESSION["try_edit_email"];
                                       } else {
                                           echo $row->getEmail();
                                       } ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="uid"
                                       value="<?php if (isset($_SESSION["try_edit_name_first"])) {
                                           echo $_SESSION["try_edit_name_first"];
                                       } else {
                                           echo $row->getNameFirst();
                                       } ?>">
